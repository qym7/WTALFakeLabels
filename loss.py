...
class GCNN_loss(nn.Module):
    ...
    def construct_pairs(self, nodes, nodes_label, index, nodes_bank):
        ...
        mask_act = mask.clone()
        mask_bkg = mask.clone()
        mask_act[:, availabel_nodes_label==20] = 0  # mask nodes of same label/bkg nodes
        mask_bkg[:, availabel_nodes_label<20] = 0  # mask nodes of same label/act nodes
