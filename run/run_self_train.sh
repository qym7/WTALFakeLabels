model_path='./models/UM-val-self-mAP-01-BCE-98-50-decay'
output_path='./outputs/UM-val-self-mAP-01-BCE-98-50-decay'
log_path='./logs/UM-val-self-mAP-01-BCE-98-50-decay'
