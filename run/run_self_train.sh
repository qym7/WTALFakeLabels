...
model_file='./models/UM-val-self-mAP-01-BCE-09-07-drop/model_seed_0.pkl'
seed=0
...
CUDA_VISIBLE_DEVICES=2 python -W ignore ./main_test.py --model_path ${model_path} --output_path ${output_path} --log_path ${log_path} --model_file ${model_file} --data_path ${data_path} --test_dataset ${test_dataset} --save '1' --supervision ${supervision}
