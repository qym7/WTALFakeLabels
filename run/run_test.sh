output_path='./outputs/UM-2-layer-cat-CONV'
log_path='./glogs/UM-2-layer-cat-CONV'
model_path='./models/UM-2-layer-cat-CONV'
model_file='./models/UM-2-layer-cat-CONV/model_seed_0.pkl'
