output_path='./outputs/UM-2-layer-cat-filter4'
log_path='./glogs/UM-2-layer-cat-filter4'
model_path='./models/UM-2-layer-cat-filter4'
model_file='./models/UM-2-layer-cat-filter4/model_seed_0.pkl'
